...
const I18N = {
  ru: {
    ...
    'works.case.tag': 'От идеи и тканей — до вдохновляющей кампании',
    'works.case.1.title': 'Бренд и вдохновение',
    'works.case.1.text': 'Океан, свет и женственность.',
    'works.case.2.title': 'Продукт и концепция',
    'works.case.2.text': 'Коллекция, ткани, детали и силуэты.',
    'works.case.3.title': 'AI-визуалы и кампания',
    'works.case.3.text': 'Атмосферные фото и видео для коллекции.',
    'works.case.4.title': 'Готовый контент и результат',
    'works.case.4.text': 'Материалы для соцсетей, сайта и рекламы.',
  ...
  en: {
    ...
    'works.case.tag': 'From idea and fabrics — to an inspiring campaign',
    'works.case.1.title': 'Brand and inspiration',
    'works.case.1.text': 'Ocean, light and femininity.',
    'works.case.2.title': 'Product and concept',
    'works.case.2.text': 'Collection, fabrics, details and silhouettes.',
    'works.case.3.title': 'AI visuals and campaign',
    'works.case.3.text': 'Atmospheric photos and video for the collection.',
    'works.case.4.title': 'Finished content and result',
    'works.case.4.text': 'Materials for social media, website and advertising.',
